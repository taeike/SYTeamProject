            ...
            <table style="width: 520px">
               ...
               <tr>
                  <td width="180px" class="td_left"><spring:message
                        code="login.email" text="default text" /></td>
                  <td width="400px"><input type="text" name="email" id="email"
                     class="form-control font" size="20" maxlength="35"> <input
                     type="hidden" name="idchk">&nbsp;&nbsp;<input
                     type="button" name="confirm_id" class="btn joinbtn"
                     value=<spring:message code="login.confirmoverlap" text="default text" />
               ...
               <tr>
                  <td width="180px" class="td_left"><spring:message
                        code="login.password" text="default text" /></td>
                  <td width="400px"><input type="password" name="password"
                     id="password" class="form-control font" size="15" maxlength="20"></td>
               </tr>
               ...
               <tr>
                  <td width="180px" class="td_left"><spring:message
                        code="login.confirmpwd" text="default text" /></td>
                  <td width="400px"><input type="password" name="password2"
                     id="password2" class="form-control font" size="15" maxlength="20"></td>
               </tr>
               ...
               <tr>
                  ...
                  <td width="400px" class="font"><input type="text"
                     name="pnumber" id="pnumber" class="form-control font" size="15px"
               ...
               <tr>
                  <td width="180px" class="td_left"><spring:message
                        code="login.birth" text="default text" /></td>
                  <td class="lLine" colspan="5"><select name="year"
                     class="form-control font">
                        <option value="0"><spring:message code="login.y"
                  ...
                  </select> <select name="month" class="form-control font">
                        <option value="0"><spring:message code="login.m"
                              text="default text" /></option>
                  ...
                  </select> <select name="day" class="form-control font">
                        <option value="0"><spring:message code="login.d"
                              text="default text" /></option>
                        <option value="01">1</option>
                        <option value="02">2</option>
                        <option value="03">3</option>
               ...
               <tr>
                  <td colspan="2" class="w3-center"><center>
                        <input type="submit" name="confirm" class="btn joinbtn"
                           value=<spring:message code="login.register" text="default text" />>
                        <input type="button" class="btn joinbtn" value="취소"
