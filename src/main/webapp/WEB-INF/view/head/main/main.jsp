...
<body>
   ...
   <center>
      <div class="w3-display-container" style="width: 1150px">

         <img class="mySlides"
            src="https://www.w3schools.com/w3css/img_nature_wide.jpg"
            style="width: 100%; height: 500px;"> <img class="mySlides"
   ...
   <div class="w3-content" style="max-width: 57%; margin-top: 50px;">
      <div class="w3-third" style="width: 45%">
         <h5>
            관광지 TOP5 <span style="padding-left: 65%;"><a href="#">more+</a></span>
         </h5>
      </div>
      ...
      <div class="w3-third" style="width: 45%">
         <h5>
            리뷰 TOP5 <span style="padding-left: 70%;"><a href="#">more+</a></span>
         </h5>
      </div>
   </div>

   <div class="w3-content w3-row-padding"
      style="max-width: 58%;; margin-top: 5px;">
      <div class="w3-third"
         style="border: 2px solid grey; padding-left: 25px; border-radius: 5px; width: 45%">
      ...
      <div class="w3-third"
         style="border: 2px solid grey; border-radius: 5px; padding-left: 25px; width: 45%">
         <table style="margin-top: 10px; margin-bottom: 10px;">
            <tr>
               <td class="num">1</td>
               <td width="30">&nbsp;</td>
   ...
   <div class="w3-content"
      style="max-width: 57%;; margin-top: 60px; border: 2px solid grey; padding-left: 25px; border-radius: 5px;">
