...
<script type="text/javascript">
	...
	"class='icon'>한국어</a> <span class='wrptxt'> <a href='http://korean.visitseoul.net' class='txt'>한국어 사이트 방문하기</a>"+
	" </span>  </span> <span class='round en'> <a href='/SYTeamProject/start/main?lang=en' class='icon'>English</a> <span class='wrptxt'>"+
	"href='http://english.visitseoul.net'  class='txt'>Visit the English site</a></span></span><span class='round jp'> <a href='/SYTeamProject/start/main?lang=jp'"+
	"class='icon'>日本</a> <span class='wrptxt'> <a href='http://korean.visitseoul.net' class='txt'>한국어 사이트 방문하기</a>"+"</span> </span><span class='round ch'> <a href='/SYTeamProject/start/main?lang=ch'"+
	"class='icon'>中国</a> <span class='wrptxt'> <a href='http://korean.visitseoul.net' class='txt'>한국어 사이트 방문하기</a>"+"</span></span></div>";
